 ...
 * Returns decision history with filtering and pagination.
 * 
...
export async function GET(request: NextRequest) {
  try {
    ...
    const params = QuerySchema.safeParse({
      ...
      engine_version: searchParams.get('engine_version') || undefined,
    ...
    const entries = await ledger.query({
      ...
      engine_version: params.data.engine_version,
